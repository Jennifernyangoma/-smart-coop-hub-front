...
import { LayoutDashboard, DollarSign, Package, Bell, Settings, LogOut, FileText } from "lucide-react";
...
const MemberContributions = () => {
  ...
  const menuItems = [
    ...
    { icon: DollarSign, label: "My Contributions", path: "/member-contributions", active: true },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="bg-white border-b border-gray-200 p-6">
          ...
          <p className="text-gray-600">Track your contributions to the cooperative</p>
        </header>

        <div className="p-6">
          <Card>
            <CardContent className="pt-6">
              <p className="text-gray-600 text-center py-12">Contributions content coming soon...</p>
            </CardContent>
          </Card>
        </div>
      </main>
